...
namespace DataAccessLayer.DataSets {
    ...
    public partial class UsersDataSet : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsersRow AddUsersRow(string FirstName, string LastName, int Age, bool Gender, string Email, string Username, string Password, int H_Id, int RoleID) {
        ...
        public partial class UsersRow : global::System.Data.DataRow {
            ...
            public int H_Id {
                get {
                    try {
                        return ((int)(this[this.tableUsers.H_IdColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'H_Id\' in table \'Users\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableUsers.H_IdColumn] = value;
                }
            }
            ...
            public bool IsH_IdNull() {
                return this.IsNull(this.tableUsers.H_IdColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetH_IdNull() {
                this[this.tableUsers.H_IdColumn] = global::System.Convert.DBNull;
            }
...
namespace DataAccessLayer.DataSets.UsersDataSetTableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([FirstName], [LastName], [Age], [Gender], [Email], [Username], [Password], [H_Id], [RoleID]) VALUES (@FirstName, @LastName, @Age, @Gender, @Email, @Username, @Password, @H_Id, @RoleID);
SELECT UserId, FirstName, LastName, Age, Gender, Email, Username, Password, H_Id, RoleID FROM Users WHERE (UserId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [FirstName] = @FirstName, [LastName] = @LastName, [Age] = @Age, [Gender] = @Gender, [Email] = @Email, [Username] = @Username, [Password] = @Password, [H_Id] = @H_Id, [RoleID] = @RoleID WHERE (([UserId] = @Original_UserId) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Age = 1 AND [Age] IS NULL) OR ([Age] = @Original_Age)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Username = 1 AND [Username] IS NULL) OR ([Username] = @Original_Username)) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_H_Id = 1 AND [H_Id] IS NULL) OR ([H_Id] = @Original_H_Id)) AND ((@IsNull_RoleID = 1 AND [RoleID] IS NULL) OR ([RoleID] = @Original_RoleID)));
SELECT UserId, FirstName, LastName, Age, Gender, Email, Username, Password, H_Id, RoleID FROM Users WHERE (UserId = @UserId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT UserId, FirstName, LastName, Age, Gender, Email, Username, Password, H_Id," +
        ...
        public virtual int Delete(int Original_UserId, string Original_FirstName, string Original_LastName, global::System.Nullable<int> Original_Age, global::System.Nullable<bool> Original_Gender, string Original_Email, string Original_Username, string Original_Password, global::System.Nullable<int> Original_H_Id, global::System.Nullable<int> Original_RoleID) {
            ...
            if ((Original_H_Id.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[16].Value = ((int)(Original_H_Id.Value));
            }
            else {
            ...
            if ((Original_RoleID.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[18].Value = ((int)(Original_RoleID.Value));
            }
            else {
        ...
        public virtual int Insert(string FirstName, string LastName, global::System.Nullable<int> Age, global::System.Nullable<bool> Gender, string Email, string Username, string Password, global::System.Nullable<int> H_Id, global::System.Nullable<int> RoleID) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_H_Id.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[25].Value = ((int)(Original_H_Id.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> Original_H_Id, 
                    global::System.Nullable<int> Original_RoleID) {
            return this.Update(FirstName, LastName, Age, Gender, Email, Username, Password, H_Id, RoleID, Original_UserId, Original_FirstName, Original_LastName, Original_Age, Original_Gender, Original_Email, Original_Username, Original_Password, Original_H_Id, Original_RoleID, Original_UserId);
        }
    }
