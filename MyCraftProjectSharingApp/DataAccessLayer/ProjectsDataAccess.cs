    ...
    public class ProjectsDataAccess
    {
        ...
        public void AddProject(DataAccessProjects projectToAdd)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Difficulty", projectToAdd.Difficulty);
                cmd.Parameters.AddWithValue("@C_Id", projectToAdd.C_Id);
                cmd.Parameters.AddWithValue("@U_Id", projectToAdd.U_Id);
                connection.Open();
                cmd.ExecuteNonQuery();
            }
        ...
        public DataAccessProjects GetProjectByProjectId(int projectId)
        {
            ...
            {
                if (projectId == dProject.ProjectId)
                {
                    projects = dProject;
                }
            }
        ...
        public void UpdateProject(int projectId, DataAccessProjects projectToUpdate)
        {
            ...
            try
            {
                ...
                cmd.Parameters.AddWithValue("@Difficulty", projectToUpdate.Difficulty);
                cmd.Parameters.AddWithValue("@C_Id", projectToUpdate.C_Id);
                connection.Open();
                cmd.ExecuteNonQuery();
            }
            catch (Exception error)
